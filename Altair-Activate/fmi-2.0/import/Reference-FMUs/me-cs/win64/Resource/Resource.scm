...
<model name="Resource">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="04/14/23 12:40:15"/>
  ...
  <finalization/>
  <diagram>
    <block name="resource_me" type="block">
      ...
      <parameters>
        <section name="General Parameters">
          <parameter name="FMUfilename" value="&apos;./Resource.fmu&apos;"/>
          ...
          <parametertable name="outports">
            ...
            <rows number="nout">
              <row>
                <value>&apos;y&apos;</value>
                <value>&apos;Value of the first character in resources/y.txt, Dims: 1&apos;</value>
                <value>&apos;Integer&apos;</value>
              </row>
            </rows>
          </parametertable>
    ...
    <block name="Display" type="block">
      ...
      <graphics>
        ...
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">    97</text>
        </texts>
        <images>
    ...
    <block name="resource_cs" type="block">
      <template name="system/CoSimulation/FMU"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="0.4141998291015625" y="-318.1466369628906"/>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="-252.10153198242188" y="-306.1488037109375"/>
    ...
    <block name="Constant" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-293.8448181152344" y="-168.11805725097656"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">97</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
    ...
    <block name="Display_2" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-178.0725555419922" y="-168.79693603515625"/>
        <size width="96" height="48"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">    97</text>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="resource_me" port="1" iotype="out"/>
    ...
    <link name="" type="explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-252.10153198242188" y="-298.1466369628906"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-235.79676818847656" y="-306.1488037109375"/>
        <point x="-235.79676818847656" y="-352.8601989746094"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="resource_cs" port="1" iotype="out"/>
      <to block="Display_1" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-178.49402618408203" y="-229.1488037109375"/>
        <point x="-178.49402618408203" y="-242.3479461669922"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-215.95868682861328" y="-148.11805725097656"/>
        <point x="-215.95868682861328" y="-144.79693603515625"/>
      </points>
    </link>
    <context/>
    <graphics>
