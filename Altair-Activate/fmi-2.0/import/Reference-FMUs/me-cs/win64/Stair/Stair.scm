...
<model name="Stair">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="04/14/23 12:11:48"/>
  ...
  <diagram>
    <block name="counter" type="block">
      ...
      <ports>
        <port name="&quot;counter&quot;" type="variableport">
          <properties>
      ...
      <parameters>
        <section name="General Parameters">
          <parameter name="FMUfilename" value="&apos;./Stair.fmu&apos;"/>
          ...
          <parametertable name="outports">
            ...
            <rows number="nout">
              <row>
                <value>&apos;counter&apos;</value>
                <value>&apos;counts the seconds, Dims: 1&apos;</value>
                <value>&apos;Int32&apos;</value>
              </row>
            </rows>
          </parametertable>
    ...
    <block name="counter_cs" type="block">
      <template name="system/CoSimulation/FMU"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
    ...
    <link name="" type="explicit">
      ...
      <to block="counter_cs" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-182.1688232421875" y="-280.89886474609375"/>
        <point x="-182.1688232421875" y="-229.1488037109375"/>
      </points>
    </link>
    <context/>
    <graphics>
