...
<model name="counter_with_reset">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="12/18/23 13:23:46"/>
  ...
  <diagram>
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <position x="146.48043823242188" y="-62.308284759521484"/>
    ...
    <block name="FMU" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-224.3298454284668" y="58.3684482574463"/>
        <size width="204" height="83.99999999999999"/>
        <rotate angle="0"/>
        <texts>
      ...
      <ports>
        ...
        <port name="&quot;ExternalClock1&quot;" type="variableport">
          <properties>
            <property name="iotype" value="in"/>
            <property name="datatype" value="Activation"/>
          ...
          <parametertable name="clocks">
            ...
            <rows number="nclocks">
              <row>
                ...
                <value>&apos;External triggered input clock: 1, nevprt=1&apos;</value>
                <value>&apos;input&apos;</value>
              ...
              <row>
                ...
                <value>&apos;Constant periodic input clock: 2, nevprt=2&apos;</value>
                <value>&apos;input&apos;</value>
    ...
    <block name="ToCSV" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="69.33392333984375" y="114.67729949951172"/>
        <size width="216" height="36"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">counter_with_reset.csv</text>
        </texts>
        <images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="fname" value="&apos;counter_with_reset.csv&apos;"/>
    ...
    <block name="Periodic clock_1" type="block">
      ...
      <graphics>
        ...
        <position x="-42.281005859375" y="-173.80912017822266"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="counter_with_reset" type="block">
      <diagram>
        <block name="Counter" type="block">
          <template name="{dd99f4d4-aa8d-4df6-a125-cf35c16235f4}/Counter"/>
          <properties>
            <property name="masked" value="1"/>
          ...
          <graphics>
            ...
            <position x="-68.64141845703125" y="-70.80912017822266"/>
            <size width="60" height="36"/>
            <rotate angle="0"/>
            <texts>
              <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">counter</text>
            </texts>
            <images>
              <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
            </images>
          ...
          <ports>
            <port name="reset" type="fixedport">
              <properties>
                <property name="iotype" value="in"/>
                <property name="datatype" value="Activation"/>
                <property name="portnumber" value="1"/>
          ...
          <parameters>
            <section name="Parameters">
              <parameter name="inc" value="1"/>
            </section>
          </parameters>
        </block>
        <block name="Reset" type="activation_in_port">
          ...
          <graphics>
            ...
            <background color="255,255,255,255"/>
            <position x="-63.64141845703125" y="-190.80912017822266"/>
        ...
        <block name="Output" type="regular_out_port">
          ...
          <graphics>
            ...
            <background color="255,255,255,255"/>
            <position x="91.35858154296875" y="-62.809120178222656"/>
            <size width="20" height="20"/>
            <rotate angle="0"/>
            <texts>
        ...
        <block name="Periodic clock" type="block">
          ...
          <graphics>
            ...
            <frame shape="rectangle" visible="0" color="0,0,0,0" thickness="1.5"/>
            <background color="255,255,255,0"/>
            <position x="26.612704277038574" y="-190.61654663085938"/>
            <size width="40" height="40"/>
            <rotate angle="0"/>
            <texts>
        ...
        <link name="" type="Activation">
          <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
          <from block="Reset" port="1" iotype="out"/>
        ...
        <link name="" type="Activation">
          ...
          <to block="Counter" port="2" iotype="in"/>
          <pen shape="line" color="183,15,19,255" thickness="1.5"/>
          <points>
            <point x="46.61270427703857" y="-158.71283340454102"/>
            <point x="-23.641418457031264" y="-158.71283340454102"/>
          </points>
        </link>
        <context/>
        <graphics>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-58.64141845703125" y="-72.80912017822266"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
    ...
    <block name="ActivationSplit" type="activation_split">
      ...
      <graphics>
        ...
        <background color="183,15,19,255"/>
        <position x="-51.64141845703125" y="-114.80912780761716"/>
    ...
    <block name="EventUnion" type="block">
      ...
      <graphics>
        ...
        <background color="255,255,255,255"/>
        <position x="98.35857391357422" y="48.190879821777344"/>
    ...
    <block name="Block_1" type="activation_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="183,15,19,255" thickness="1.5"/>
        <background color="183,15,19,255"/>
        <position x="-173.3298454284668" y="26.19087791442865"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="27.35857391357422" y="100.36844825744629"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Periodic clock_1" port="1" iotype="out"/>
      <to block="ActivationSplit" port="1" iotype="in"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-22.281005859374996" y="-114.80912780761716"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="counter_with_reset" port="1" iotype="out"/>
      <to block="Scope" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="55.35857391357422" y="-52.809120178222656"/>
        <point x="55.35857391357422" y="-52.308284759521484"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Activation">
      ...
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-122.3298454284668" y="26.190877914428643"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="ActivationSplit" port="1" iotype="out"/>
      <to block="counter_with_reset" port="1" iotype="in"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-38.64141845703126" y="-114.80912780761716"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="EventUnion" port="1" iotype="in"/>
      <to block="Block_1" port="2" iotype="out"/>
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="108.35857391357423" y="26.190877914428594"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="-173.3298454284668" y="-114.80912780761714"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="118.35857391357423" y="85.43408966064455"/>
        <point x="177.33392333984378" y="85.43408966064392"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="27.35857391357422" y="132.67729949951172"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="63.07529640197754" y="100.36844825744629"/>
        <point x="63.07529640197754" y="-32.308284759521484"/>
      </points>
    </link>
    <link name="" type="Activation">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      ...
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="3.014364242553725" y="152.36844825744626"/>
        <point x="3.0143642425536967" y="38.19087982177737"/>
      </points>
    </link>
    <context/>
    <graphics>
