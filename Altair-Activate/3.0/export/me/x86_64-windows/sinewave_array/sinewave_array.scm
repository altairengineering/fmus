...
<model name="sinewave_array">
  <header formatversion="2" hwxversion="2022.3" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="masoud"/>
      <property name="creationdate" value="01/04/22 11:26:22"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="04/05/23 19:48:59"/>
      <property name="comments" value=""/>
    </properties>
  </edition>
  <initialization>Amplitude=[1,2,3;4,5,6;7,8,9];&#xA;Frequency=ones(3,3);&#xA;Phase=[1,2,3;4,5,6;7,8,9]*0.0;&#xA;Offset=[1,2,3;4,5,6;7,8,9];</initialization>
  <finalization/>
  <diagram>
    <block name="Display" type="block">
      ...
      <graphics>
        ...
        <position x="655.438720703125" y="-343.78216552734375"/>
        <size width="180" height="48"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">   0.0410757   0.0821515    0.123227&#xA;    0.164303    0.205379    0.246454&#xA;     0.28753    0.328606    0.369682</text>
        </texts>
        <images>
    ...
    <block name="sinewave_array" type="block">
      <diagram>
        <block name="Output" type="regular_out_port">
          ...
          <graphics>
            ...
            <background color="255,255,255,255"/>
            <position x="524.0226135253906" y="-280.19122314453125"/>
        ...
        <block name="SineWaveGenerator" type="block">
          ...
          <graphics>
            ...
            <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="375.402099609375" y="-290.19122314453125"/>
          ...
          <parameters>
            <section name="Parameters">
              <parameter name="M" value="Amplitude"/>
              <parameter name="F" value="Frequency"/>
              <parameter name="P" value="Phase"/>
              <parameter name="offs" value="Offset"/>
              <parameter name="externalActivation" value="0"/>
            </section>
          </parameters>
        </block>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="330.3454895019531" y="-339.78216552734375"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
      ...
      <parameters title="new block definition">
        ...
        <section name="Parameters">
          <parameter name="Frequency" value="Frequency" widget="lineedit" type="generic" callback="" displayname="Frequency" tooltip="" unit="" dimensions="[]" visible="1" enabled="1"/>
          <parameter name="Offset" value="Offset" widget="lineedit" type="generic" callback="" displayname="Offset" tooltip="" unit="" dimensions="[]" visible="1" enabled="1"/>
          <parameter name="Phase" value="Phase" widget="lineedit" type="generic" callback="" displayname="Phase" tooltip="" unit="" dimensions="[]" visible="1" enabled="1"/>
          <parameter name="Amplitude" value="Amplitude" widget="lineedit" type="generic" callback="" displayname="Amplitude" tooltip="" unit="" dimensions="[]" visible="1" enabled="1"/>
        </section>
      </parameters>
    </block>
    <block name="FMU" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="329.37554931640625" y="-243.53863525390625"/>
      ...
      <parameters>
        <section name="General Parameters">
          <parameter name="FMUfilename" value="&apos;./sinewave_array.fmu&apos;"/>
          ...
          <parametertable name="outports">
            ...
            <rows number="nout">
              <row>
                <value>&apos;Output&apos;</value>
                <value>&apos;, Dims: [3,3]&apos;</value>
                <value>&apos;Float64&apos;</value>
              </row>
            </rows>
          </parametertable>
          <parameter name="nparam" value="4"/>
    ...
    <block name="Display_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="656.3937377929688" y="-249.53863525390625"/>
        <size width="180" height="48"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.500000" y="0.500000" rotate="1" visible="1" font="Arial,10" align="center">   0.0410757   0.0821515    0.123227&#xA;    0.164303    0.205379    0.246454&#xA;     0.28753    0.328606    0.369682</text>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="542.8116455078125" y="-374.20867919921875"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="521.9820556640625" y="-319.78216552734375"/>
    ...
    <block name="Scope_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="547.3482666015625" y="-284.9884338378906"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Block" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="524.2503662109375" y="-225.53863525390625"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="ToCSV" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="537.0374755859375" y="-182.58155822753906"/>
        <size width="180" height="48"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">sinewave_array.csv</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="fname" value="&apos;sinewave_array.csv&apos;"/>
          <parameter name="nin" value="1"/>
          <parametertable name="inports">
            <columns number="2">
    ...
    <block name="Block_1" type="regular_split">
      ...
      <graphics>
        ...
        <frame shape="ellipse" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="64,64,64,255"/>
        <position x="473.4574890136719" y="-225.53863525390625"/>
        <size width="0" height="0"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="sinewave_array" port="1" iotype="out"/>
    ...
    <link name="" type="explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="521.9820556640625" y="-354.20867919921875"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="524.2503662109375" y="-264.9884338378906"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="473.4574890136719" y="-158.58155822753906"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
