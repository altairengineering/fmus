...
<model name="clocked_counter">
  <header formatversion="2" hwxversion="2023.1" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="masoud"/>
      <property name="creationdate" value="12/14/23 09:22:34"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="12/14/23 17:38:53"/>
  ...
  <diagram>
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <position x="76.48042297363281" y="-88.30828475952148"/>
    ...
    <block name="FMU" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-31.329853057861328" y="-17.631553649902344"/>
      ...
      <parameters>
        <section name="General Parameters">
          <parameter name="FMUfilename" value="&apos;./clocked_counter.fmu&apos;"/>
          ...
          <parametertable name="clocks">
            ...
            <rows number="nclocks">
              <row>
                ...
                <value>&apos;Constant periodic input clock: 1, nevprt=1&apos;</value>
                <value>&apos;input&apos;</value>
    ...
    <block name="Scope_1" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="109.9531478881836" y="-17.631553649902344"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="Scope_2" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="194.79029083251953" y="141.80178833007812"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="clocked_counter" type="block">
      <diagram>
        <block name="Constant" type="block">
          ...
          <graphics>
            ...
            <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
            <background color="255,255,255,255"/>
            <position x="-203.86407470703125" y="-115.21087646484375"/>
            <size width="40" height="40"/>
            <rotate angle="0"/>
            <texts>
          ...
          <diagram>
            <block name="EventOutput" type="activation_out_port">
              ...
              <graphics>
                ...
                <background color="255,255,255,255"/>
                <position x="-8.500000000000004" y="-12.71240234375"/>
            ...
            <block name="Periodic clock" type="block">
              ...
              <graphics>
                ...
                <position x="-18.500000000000004" y="-152.71240234375"/>
                <size width="40" height="40"/>
                <rotate angle="0"/>
                <texts>
            ...
            <link name="" type="Activation">
              <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
              <from block="Periodic clock" port="1" iotype="out"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-21.281005859375" y="-88.30828475952148"/>
        <size width="40" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center"/>
    ...
    <block name="ToCSV" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="90.33392333984375" y="101.67729187011719"/>
        <size width="100" height="40"/>
        <rotate angle="0"/>
        <texts>
          <text name="text1" color="0,0,0,255" clip="1" x="0.5" y="0.5" rotate="1" visible="1" font="Arial,12" align="center">clocked_counter.csv</text>
        </texts>
        <images>
          <image name="image1" file="" visible="1" alpha="255" aspectratio="1" x="0" y="0" width="1" height="1" clip="1" rotate="1"/>
        </images>
      ...
      <parameters>
        <section name="Parameters">
          <parameter name="fname" value="&apos;clocked_counter.csv&apos;"/>
          <parameter name="nin" value="1"/>
          <parametertable name="inports">
            <columns number="2">
    ...
    <block name="Split" type="regular_split">
      ...
      <graphics>
        ...
        <background color="64,64,64,255"/>
        <position x="54.333919525146484" y="2.3684463500976562"/>
    ...
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="clocked_counter" port="1" iotype="out"/>
    ...
    <link name="" type="Explicit">
      ...
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="54.333919525146484" y="121.67729187011719"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
    ...
    <link name="" type="Activation">
      ...
      <pen shape="line" color="183,15,19,255" thickness="1.5"/>
      <points>
        <point x="1.1701469421387003" y="62.02286911010743"/>
        <point x="140.33392333984375" y="62.02286911010739"/>
      </points>
    </link>
    <context/>
    <graphics>
