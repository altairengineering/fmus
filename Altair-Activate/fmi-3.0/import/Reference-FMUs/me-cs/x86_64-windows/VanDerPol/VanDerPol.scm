...
<model name="VanDerPol">
  ...
  <edition>
    <properties>
      ...
      <property name="lastmodifieddate" value="04/14/23 12:13:48"/>
      <property name="comments" value=""/>
    </properties>
  </edition>
  <initialization>mu=2</initialization>
  <finalization/>
  <diagram>
    <block name="VanDerPol" type="block">
      ...
      <graphics>
        ...
        <position x="-413.00799560546875" y="-326.1488037109375"/>
      ...
      <ports>
        <port name="&quot;x0&quot; &quot;x1&quot;" type="variableport">
          <properties>
      ...
      <parameters>
        <section name="General Parameters">
          <parameter name="FMUfilename" value="&apos;./VanDerPol.fmu&apos;"/>
          <parameter name="NX" value="2"/>
          ...
          <parametertable name="outports">
            ...
            <rows number="nout">
              <row>
                <value>&apos;x0&apos;</value>
                <value>&apos;the first state, Dims: 1&apos;</value>
                <value>&apos;Float64&apos;</value>
              </row>
              <row>
                <value>&apos;x1&apos;</value>
                <value>&apos;the second state, Dims: 1&apos;</value>
                <value>&apos;Float64&apos;</value>
              </row>
            </rows>
          </parametertable>
    ...
    <block name="VanDerPol_cs" type="block">
      <template name="system/CoSimulation/FMU"/>
      <properties>
        <property name="inlinable" value="0"/>
        <property name="masked" value="1"/>
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-408.00799560546875" y="-247.1488037109375"/>
    ...
    <block name="Scope" type="block">
      ...
      <graphics>
        ...
        <frame shape="rectangle" visible="1" color="0,0,0,255" thickness="1.5"/>
        <background color="255,255,255,255"/>
        <position x="-100.32965087890625" y="-310.89886474609375"/>
    ...
    <link name="" type="Explicit">
      ...
      <from block="VanDerPol" port="1" iotype="out"/>
      <to block="Scope" port="1" iotype="in"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-259.00799560546875" y="-300.8988647460938"/>
      </points>
    </link>
    <link name="" type="explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
      <from block="Scope" port="2" iotype="in"/>
      <to block="VanDerPol_cs" port="1" iotype="out"/>
      <pen shape="line" color="64,64,64,255" thickness="1.5"/>
      <points>
        <point x="-182.1688232421875" y="-280.89886474609375"/>
        <point x="-182.1688232421875" y="-238.1488037109375"/>
      </points>
    </link>
    <context/>
    <graphics>
